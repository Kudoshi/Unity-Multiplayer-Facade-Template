...
public class LobbyRoomManager : MonoBehaviour
{
    ...
    private void OnPlayerDataChangeHandler(CustomLobby lobby, LobbyPlayer player)
    {
        ...
        //Debug.Log("[LobbyRoomManager] Player data changed: " + player.Name);
    }
    ...
    private void OnPlayerJoinHandler(CustomLobby lobby, LobbyPlayer player)
    {
        _lobby = lobby;
        AddPlayer(player);
        //Debug.Log("[LobbyRoomManager] Player joined: " + player.Name);
    }
    ...
    private void OnPlayerLeaveHandler(CustomLobby lobby, LobbyPlayer player)
    {
        _lobby = lobby;
        RemovePlayer(player);
        //Debug.Log("[LobbyRoomManager] Player left: " + player.Name);
    }
    ...
    {
        _lobby = lobby;
        //Debug.Log("[LobbyRoomManager] Player invited: " + player.Name);
    }
